...
func Migrate() {
	...
	db.AutoMigrate(&goRedisAdmin.User{})
	db.AutoMigrate(&goRedisAdmin.Role{})
	db.AutoMigrate(&goRedisAdmin.Rule{})
	db.AutoMigrate(&goRedisAdmin.RedisList{})
...
func InitMenu(db *gorm.DB) {
	...
	tx = db.Create(&goRedisAdmin.Menu{
